...
1. Boost learning efficiency with on-demand AI guidance.  
2. Encourage creativity and problem-solving with idea generation.  
3. Improve writing, research, and coding skills.  
4. Maintain focus with a clean, distraction-free interface.  
5. Empower students who have limited access to AI tools.  
...
Contributing
Sonata is open-source and welcomes contributions. Fork the repo, create a branch, add your improvements, and submit a pull request.